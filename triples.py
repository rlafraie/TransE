...
class Data:
    ...
    def load_entity_dict(self):
        ...
        entity_file = open(os.path.join(self.data_dir, entity_file_name))
    ...
    def load_relation_dict(self):
        ...
        relation_file = open(os.path.join(self.data_dir,relation_file_name))
    ...
    def load_triples(self):
        ...
        with open(os.path.join(self.data_dir, training_file_name)) as train_f:
        ...
        with open(os.path.join(self.data_dir, validation_file_name)) as validation_f:
